...
if [ $MonitorCount -eq 3 ]; then
    ...
    if [ $VirtualMonitorCount -eq 4 ]; then
        ...
        herbstclient set_monitors 1920x1080+0+560 2560x1032+1920+560 1080x1920+4480+0
    else
        notify-send --icon=gtk-info Monitors "3 monitors found\nChanging to office setup (1 Virtual Monitor)"
        herbstclient set_monitors 1920x1080+0+560 2100x1032+1920+560 460x1032+4020+560 1080x1920+4480+0
    fi
else
# or simply:
    hc detect_monitors
